...
# this class is help to stop take gradient of tensor in case i make evaluation etc
class no_grad:
    def __enter__(self):
...
class Tensor:
    ...
    def __init__(self, data, requires_grad=False,grad_fn=None, grad_fn_name=None,device=None,dtype=None):
    ...
    def retain_grad(self):
        ...
        # Leaf Tensors always retain grad we need to save
        if self.is_leaf:
            return 
    ...
    def backward(self, 
        ...
        # tapological sort to sort node in graph
        self.grad = grad
